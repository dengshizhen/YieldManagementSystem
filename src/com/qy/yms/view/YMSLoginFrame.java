...
import com.qy.yms.server.YMSLoginManeger;
...
public class YMSLoginFrame implements ActionListener{
	public static final String logoon = "登录";
	public static final String helpt = "查看";
	...
	private javax.swing.JPanel jp = new javax.swing.JPanel(){
		public void paintComponent(Graphics g){
			...
			GradientPaint gradientPaint = new GradientPaint(0,0,java.awt.Color.WHITE,width/2,height/2,java.awt.Color.white,false);
	...
	*/
	public YMSLoginFrame(){
		...
		javax.swing.ImageIcon pic = new javax.swing.ImageIcon(YMSAddFrame.class.getResource("qiyao.png"));
		...
		logoin.addKeyListener(new KeyListener(){
			...
			public void keyPressed(KeyEvent e){
				if((e.getKeyChar()==KeyEvent.VK_ENTER )){
					...
					boolean b = YMSLoginManeger.logoon(userText.getText().trim(), userpwd.getText().trim());
					SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
					Date date = new Date(System.currentTimeMillis());
					String day = sdf.format(date);
					String s ="'"+day+"','"+userText.getText().trim()+"','"+"登录"+"'";
					String sql = "insert into handle_record values("+s+")";
					YMSLoginManeger.UpdateDB(sql);
					if(b){
						logo_Frame.dispose();
						new YMSMainFrame(userText.getText().trim());
						}
					userText.setText("");
					userpwd.setText("");
					userText.requestFocus();
