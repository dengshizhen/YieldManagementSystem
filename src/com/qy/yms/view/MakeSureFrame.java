...
public class MakeSureFrame extends JDialog implements ActionListener{
	...
	ActionEvent event;
	public MakeSureFrame(JFrame owner,boolean modal) throws HeadlessException {
		// TODO 自动生成的构造函数存根
		jDialog=new JDialog(owner, "check", modal);
		jp1=new JPanel();
		jlb1=new JLabel("确认无误，若需修改，请返回");
		jlb2=new JLabel("出错将无法修改，只能另建一个");
		jb1=new JButton("返回");
