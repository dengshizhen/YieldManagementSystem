...
public class YMSMainCheckFrame extends javax.swing.JFrame implements ActionListener{
	...
	ImageIcon qiyao;
	String title;
	public YMSMainCheckFrame(String name)  {
		// TODO 自动生成的构造函数存根
		/**
		 * 实现各个部件，由北至南
		 */
		...
		jp2=new JPanel(new GridLayout(2, 1,100,100));
		jp2.setPreferredSize(new Dimension(450,300));
		try {
